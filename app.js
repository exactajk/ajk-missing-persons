...
function initAppState() {
    ...
    // 2. INSTANT CACHE-FIRST LOAD: Render saved records or DEFAULT_RECORDS immediately (0ms delay)!
    ...
    // Render IMMEDIATELY so page is NEVER blank or disappearing on refresh!
    renderAllViews();

    // 3. BACKGROUND SYNC with Firebase Firestore (doesn't wipe or delay UI)
